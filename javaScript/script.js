//variaveis
var palavras = ["FISICO", "ADVOGADO", "BIOLOGO", "MUSICO", "TEOLOGO", "PEDAGOGO", "ARQUITETO", "QUIMICO", "ARTESAO", "FILOSOFO", "CARTEIRO", "CANTOR", "FISICO", "HUMORISTA", "BARBEIRO", "MAQUINISTA", "PADEIRO", "TRADUTOR", "VENDEDOR", "OBSTETRA"];
var letras = [];
...
function verificaPalavraDoInput() {
    valorPalavra = (inputAddPalavra.value).toUpperCase();
        if ((valorPalavra.length < 4) || (valorPalavra.length > 8)){
            alert("Digite o nome de uma profissão com até 8 letras!");
